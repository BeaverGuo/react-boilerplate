...
Product* Creator::Create (ProductId id) {
    if (id == MINE)  return new MyProduct;// or use switch
...
Product* MyCreator::Create (ProductId id) {//overriding Create method in Creator
    ...
    return Creator::Create(id); // called if all others fail.do not forget default behaviors
}
