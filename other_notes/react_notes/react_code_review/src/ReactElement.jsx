...
var ReactElement = function (type, key, ref, self, source, owner, props) {
  var element = {
    ...
    // Record the component responsible for creating this element. how to understand?
    _owner: owner
  };
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    if (canDefineProperty) {
      Object.defineProperty(element._store, 'validated', {//bool type for comparing
        configurable: false,
        enumerable: false,
        writable: true,
        value: false
 ...
 */
ReactElement.createElement = function (type, config, children) {//<Router></Router>
  var propName;
