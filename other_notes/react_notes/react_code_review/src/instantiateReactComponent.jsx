...
var ReactCompositeComponentWrapper = function (element) {
  this.construct(element);//add some member to element
};
_assign(ReactCompositeComponentWrapper.prototype, ReactCompositeComponent.Mixin, {//prototype assignment? merge three objects to the first ReactCompositeComponentWrapper.prototype
